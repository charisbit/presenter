...
BLOG_AUTHOR = "Intelligent Presenter Team"  # (translatable)
BLOG_TITLE = "Intelligent Presenter Documentation"  # (translatable)
...
BLOG_EMAIL = "team@intelligentpresenter.dev"
BLOG_DESCRIPTION = "Complete documentation for the Intelligent Presenter project - HTML slide presentation system with AI-powered features"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ("/", "Home"),
        ("/pages/api-documentation/", "API Documentation"), 
        ("/pages/backend-docs/", "Backend (Go)"),
        ("/pages/frontend-docs/", "Frontend (TypeScript)"),
